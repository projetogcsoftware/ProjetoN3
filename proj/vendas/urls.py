...
from .views import lista_venda,cria_venda,altera_venda,deleta_venda,lista_mesa,cria_mesa,fecha_venda,libera_produto,testar
...
urlpatterns = [
    ...
    path('testar/',testar,name='testar'),
]